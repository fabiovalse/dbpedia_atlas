...
(function() {
  var C, CELL_RADIUS, GRID_HEIGHT, GRID_WIDTH, M, REGION_LABEL_MIN_AREA, SIMPLIFICATION, SIZE, cities_layer, cos30, cursor, defs, depth_color, dx, dy, inset_color, land_layer, map_layer, path_generator, region_labels_layer, relations_layer, sea_layer, sin30, svg, vis, zoom_layer, _get_hexagon, _hex_path, _ij_to_xy, _init_modes, _move_cursor, _preprocess, _preprocess_selection, _update_lod;
