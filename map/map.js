...
(function() {
  var C, CELL_RADIUS, GRID_HEIGHT, GRID_WIDTH, M, REGION_LABEL_MIN_AREA, SIMPLIFICATION, SIZE, UNTYPED_DX, UNTYPED_DY, cities_layer, cos30, cursor, cursor_layer, data_props_density_color, defs, depth_color, dx, dy, inset_color, land_layer, leaf_labels_layer, map_layer, obj_props_density_color, path_generator, region_labels_layer, relations_layer, sea_layer, sin30, svg, triple_density_color, untyped_land_layer, untyped_layer, untyped_relations_layer, vis, zoom_layer, _draw_leaf_labels, _get_hexagon, _hex_path, _ij_to_xy, _init_modes, _move_cursor, _on_hex_click, _preprocess, _preprocess_selection, _update_lod;
  ...
  */
  ...
  map.init = function(dom_node) {
    ...
    */
    ...
    untyped_relations_layer.append('g').attr({
      "class": 'links'
    });
