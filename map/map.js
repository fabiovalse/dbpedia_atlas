...
(function() {
  var C, CELL_RADIUS, GRID_HEIGHT, GRID_WIDTH, M, REGION_LABEL_MIN_AREA, SIMPLIFICATION, SIZE, cities_layer, cos30, cursor, defs, dx, dy, land_layer, map_layer, path_generator, region_labels_layer, relations_layer, sea_layer, sin30, svg, vis, zoom_layer, _get_hexagon, _hex_path, _ij_to_xy, _move_cursor, _update_lod;
  ...
  */
  ...
  map.load = function(data) {
    var cities, cities_data, classes, colors, enter_cities, enter_region_labels, enter_region_labels_foreground, enter_region_labels_halo, inset_color, region_clips, region_labels;
    map.preprocess(data);
    /* fill the sea
    */
    ...
    */
    ...
    land_layer.selectAll('.region').data(ontology.levels[1]).enter().append('path').attr({
      "class": 'region',
      d: function(n) {
        return path_generator(n.merged_region);
      },
