...
(function() {
  var C, CELL_RADIUS, GRID_HEIGHT, GRID_WIDTH, M, SIMPLIFICATION, SIZE, class_color, cos30, cursor, defs, dx, dy, land_layer, map_layer, path_generator, relations_layer, sea_layer, sin30, svg, vis, zoom_layer, _get_hexagon, _ij_to_xy, _move_cursor;
  ...
  */
  ...
  map.load = function(data) {
    ...
    */
    ...
    return land_layer.append('path').datum(topojson.mesh(data, data.objects.leaf_regions, function(a, b) {
      return a === b || a.properties.path[1] !== b.properties.path[1];
