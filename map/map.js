...
(function() {
  var C, CELL_RADIUS, GRID_HEIGHT, GRID_WIDTH, M, SIMPLIFICATION, SIZE, cities_layer, class_color, cos30, cursor, defs, dx, dy, land_layer, map_layer, path_generator, relations_layer, sea_layer, sin30, svg, vis, zoom_layer, _get_hexagon, _ij_to_xy, _move_cursor;
    ...
    */
    ...
    svg.call(d3.behavior.zoom().scaleExtent([0.01, 49]).on('zoom', function() {
      ...
      */
      ...
      return zoom_layer.selectAll('.city > *').attr({
  ...
  */
  ...
  map.load = function(data) {
    ...
    */
    ...
    })).attr('d', path_generator).attr('class', 'boundary low').style('stroke-width', '0.2px');
    land_layer.append('path').datum(topojson.mesh(data, data.objects.leaf_regions, function(a, b) {
      return a === b || a.properties.path[1] !== b.properties.path[1];
    ...
    */
    ...
    enter_cities.append('circle').attr({
      r: 0.35
    });
