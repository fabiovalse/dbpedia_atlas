...
(function() {
  var C, CELL_RADIUS, GRID_HEIGHT, GRID_WIDTH, M, SIMPLIFICATION, SIZE, cities_layer, cos30, cursor, defs, dx, dy, land_layer, map_layer, path_generator, relations_layer, sea_layer, sin30, svg, vis, zoom_layer, _get_hexagon, _hex_path, _ij_to_xy, _move_cursor;
  ...
  */
  ...
  map.load = function(data) {
    var cities, cities_data, classes, colors, enter_cities, inset_color, region_clips;
    map.preprocess(data);
    /* fill the sea
    */
